...
% Per stampare:
%\documentclass[aspectratio=141,10pt,handout]{beamer}
%\usepackage{pgfpages}
    ...
    \begin{textblock*}{15cm}(4.8cm,0.1cm)
        \scriptsize
            ...
            \begin{flushleft}
                ...
                \fcolorbox{color3}{white}{Trasmittanza termica periodica $Y_{12} [\times\SI{.e-2}{\watt\per\metre\squared\per\kelvin}]$} 
                \fcolorbox{color4}{white}{Sfasamento $[\SI{}{\hour}]$} \\
                \fcolorbox{color5}{white}{Fattore di attenuazione $[\times\SI{.e-1}{}]$} \\
                \fcolorbox{color6}{white}{Capacità termica periodica interna $k_1 [\times \SI{.e1}{\kilo\joule\per\metre\squared\per\kelvin}]$} 
                }
            \end{flushleft}
        \end{textblock*}
\end{frame}
